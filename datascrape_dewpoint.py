...
def scrape(url):
    ...
    while total_count < 500: 
        ...
        try:
            dewpoint_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,  f'/html/body/div[1]/div/div[6]/div/div/div/div/div[1]/div[1]/div[1]/div[1]/form/div[1]/div[1]/div/div[2]/div/div[2]/div[2]/div[1]/div/a[8]')))
            dewpoint_button.click()
        except Exception as e: 
            print("error dew point")
            ...
            try:
                if(key != False):
                    if(key in masterdict):
                        ...
                        masterdict[key]["dewpoint"].append(src)
                        # print(f"new value: {masterdict[key]}")
                    else: 
                        print(f"Key: [{key}] Src: [{src}]")
                        masterdict[key] = {"dewpoint": [src]} 
                ...
                masterdict[key] = {"dewpoint":[]}
            
            formatted = json.dumps(masterdict, indent=4)
            # print(f"formatted: {formatted}")

            f.close()
            with open("data_dewpoint.json", 'w') as f:
...
if __name__ == '__main__': 
    ...
    # new_url = "https://weather.us/observations/baltimore/dewpoint-f/20230727-1100z.html"
    # new_url = "https://weather.us/observations/baltimore/dewpoint-f/20230530-1400z.html"
    new_url = "https://weather.us/observations/baltimore/dewpoint-f/20231130-0500z.html"
