...
def scrape(url):
    ...
    while total_count < 500: 
        ...
        try:
            dp_spread_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,  f'/html/body/div[1]/div/div[6]/div/div/div/div/div[1]/div[1]/div[1]/div[1]/form/div[1]/div[1]/div/div[2]/div/div[2]/div[2]/div[2]/div/div/div[2]/div/a[11]')))
            dp_spread_button.click()
        except Exception as e: 
            print("error dew point spread")
            ...
            try:
                if(key != False):
                    if(key in masterdict):
                        ...
                        if(src not in masterdict[key]["dewpoint_spread"]):
                            masterdict[key]["dewpoint_spread"].append(src)
                        else:
                            print("Error: Value already in dictionary skippping. ")
                        # print(f"new value: {masterdict[key]}")
                    else: 
                        print(f"Key: [{key}] Src: [{src}]")
                        masterdict[key] = {"dewpoint_spread": [src]} 
                ...
                masterdict[key] = {"dewpoint_spread":[]}
        ...
        if writeCount >= 10:  
            with open("data_dpspread.json", 'w') as f:
...
if __name__ == '__main__': 
    ...
    # new_url = "https://weather.us/observations/baltimore/dewpoint-diff-f/20231130-0400z.html"
    # new_url = "https://weather.us/observations/baltimore/dewpoint-diff-f/20221217-2100z.html"
    # new_url = "https://weather.us/observations/baltimore/dewpoint-diff-f/20221017-1300z.html"
    new_url = "https://weather.us/observations/baltimore/dewpoint-diff-f/20210304-2300z.html"
