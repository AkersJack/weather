...
def scrape(url):
    ...
    while total_count < 500: 
        ...
        try:
            humidity_button = WebDriverWait(driver, 5).until(EC.element_to_be_clickable((By.XPATH,  f'/html/body/div[1]/div/div[6]/div/div/div/div/div[1]/div[1]/div[1]/div[1]/form/div[1]/div[1]/div/div[2]/div/div[2]/div[2]/div[1]/div/a[7]')))
            humidity_button.click()
            ...
            try:
                if(key != False):
                    if(key in masterdict):
                        ...
                        if(src not in masterdict[key]["humidity"]):
                            masterdict[key]["humidity"].append(src)
                        else:
                            print("Error: Value already exists skipping.")
                        # print(f"new value: {masterdict[key]}")
                    else: 
                        print(f"Key: [{key}] Src: [{src}]")
                        masterdict[key] = {"humidity": [src]} 
        ...
        if writeCount >= 50: 
            with open("data_humidity.json", 'w') as f:
...
if __name__ == '__main__': 
    ...
    # new_url = "https://weather.us/observations/baltimore/humidity/20230716-0000z.html"
    # new_url = "https://weather.us/observations/baltimore/humidity/20230712-1700z.html"
    # new_url = "https://weather.us/observations/baltimore/humidity/20230430-0500z.html"
    # new_url = "https://weather.us/observations/baltimore/humidity/20231129-1600z.html"
    # new_url = "https://weather.us/observations/baltimore/humidity/20231130-0500z.html"
    # new_url = "https://weather.us/observations/baltimore/humidity/20230808-1400z.html"
    new_url = "https://weather.us/observations/baltimore/humidity/20211110-1600z.html"
