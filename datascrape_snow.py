...
def scrape(url):
    ...
    while total_count < 500: 
        ...
        try:
            snow_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,  f'/html/body/div[1]/div/div[6]/div/div/div/div/div[1]/div[1]/div[1]/div[1]/form/div[1]/div[1]/div/div[2]/div/div[2]/div[2]/div[2]/div/div/div[5]/div/a[5]')))
            snow_button.click()
        ...
        while current_cache_size > 0: 
            ...
            f.close()
            with open("data_snow.json", 'w') as f:
