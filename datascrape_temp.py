...
def scrape(url):
    ...
    while total_count < 500: 
        ...
        try:
            temp_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,'/html/body/div[1]/div/div[6]/div/div/div/div/div[1]/div[1]/div[1]/div[1]/form/div[1]/div[1]/div/div[2]/div/div[2]/div[2]/div[1]/div/a[4]')))
            temp_button.click()
            ...
            try:
                if(key != False):
                    if(key in masterdict):
                        ...
                        if(src not in masterdict[key]["temperature"]):
                            masterdict[key]["temperature"].append(src)
                        else:
                            print("Error value already in masterdict skipping.")
                        # print(f"new value: {masterdict[key]}")
                    else: 
                        print(f"Key: [{key}] Src: [{src}]")
                        masterdict[key] = {"temperature": [src]} 
        ...
        print(f"Write counter: {writeCounter}")
        if writeCounter >= 50: 
...
if __name__ == '__main__': 
    ...
    # new_url = "https://weather.us/observations/baltimore/temperature-f/20230930-1600z.html"
    # new_url = "https://weather.us/observations/baltimore/temperature-f/20231130-0500z.html"
    # new_url = "https://weather.us/observations/baltimore/temperature-f/20230716-2000z.html"
    new_url = "https://weather.us/observations/baltimore/temperature-f/20220207-0000z.html"
